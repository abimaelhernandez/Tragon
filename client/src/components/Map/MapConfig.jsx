...
const googleMapKey = `https://maps.googleapis.com/maps/api/js?keimport { withScriptjs, withGoogleMap, GoogleMap, Marker } from "react-google-maps";
y=${process.env.GOOGLE_API}`;
